...
CREATE TABLE "InventoryLot" (
    "id" TEXT NOT NULL,
    "sourceType" TEXT NOT NULL DEFAULT 'SUPPLIER_PURCHASE',
...
-- AddForeignKey
ALTER TABLE "InventoryLot" ADD CONSTRAINT "InventoryLot_purchaseId_fkey" FOREIGN KEY ("purchaseId") REFERENCES "SupplierPurchase"("id") ON DELETE SET NULL ON UPDATE CASCADE;
